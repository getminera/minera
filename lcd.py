...
try:
    ...
    if response.status_code == 200:
        ...
        if not lcd['error']:
            ...
            print "`-'    `-'`-' `-'`-'  `-' `-'  `----'"
            print
            print "\033[1;32mAvailable:\033[1;37m%20.8f PIRATE" % lcd['available']
            print "\033[1;32mStake:\033[1;37m%24.8f PIRATE" % lcd['stake']
            print "\033[1;32mTotal:\033[1;37m%24.8f PIRATE" % (lcd['available'] + lcd['stake'])
            print
